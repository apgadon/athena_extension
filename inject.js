...
(function() {
	...
	*/
	...
	cssvar_inj.textContent = ':root { --z: 99998; --z2: 99999;'
	    + '--color1: #f1c40f; --color2: #f39c12; --color3: #3c3e50; --color4: #44495e;}'
	...
	div_inj.setAttribute("style", "z-index: var(--z); position: fixed; top: 10px; right: 10px;  width: 357px; height: 357px; border: 15px solid var(--color4); border-radius:1%; border-bottom-left-radius: 10%; border-bottom-color: var(--color3); border-left-color: var(--color3); background-color: var(--color4); color: white;");
	...
	extbtn_inj.setAttribute("style", "z-index: var(--z2); position:absolute; border: 5px solid var(--color4); background-color:var(--color4); border-bottom-left-radius: 50%; border-bottom-color: var(--color3); border-left-color: var(--color3); top:-2%; left:90%; font-weight: bold; color:white;");
	...
	title_inj.setAttribute("style", " padding: 10px; font-family: \"Segoe UI\", Tahoma, sans-serif; font-weight: 200; color: white");
